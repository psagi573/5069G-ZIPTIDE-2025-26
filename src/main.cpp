...
float ket=0;
float jj;////////////////////////////////////////////////80%/////////////////////////////
void fuckUBITCHprajwaluNIGGER2(float btargetvalue,float fuckKETANkP, float fuckKETNkD, float fuc, bool GayAssFuKer, float btimeout){
  ...
  while(true) {
    ...
    nig = btargetvalue - pp;
    dir = nig - ket;
    jj = (fuckKETANkP*nig)+(fuckKETNkD*dir);
    ...
    if ((fabs(nig) < 1 && fabs(nig - ket) < 0.2) || (belapsedtime >= btimeout)) {
      break;
    }
...
Hood.set(true);
fuckUBITCHprajwaluNIGGER2(30, 1.2, 0.1, 70, true, 5000);
drive(-20.5,1000);
oo=false;
wait(300,msec);
turn(180,1000);
...
turn(270,1000);
turn(260,1000);
fuckUBITCHprajwaluNIGGER2(60, 1.2, 0.1, 80, true, 5000);
turn(230,1000);
/*wait(0.4,sec);
RollerIntake.spin(forward);
turn(120,1000);
